...
| Color      | Hex                                                              |
| ---------- | ---------------------------------------------------------------- |
| Main       | ![#448FFF](https://via.placeholder.com/10/448FFF.png) `#448FFF` |
| secondary  | ![#B2D1FF](https://via.placeholder.com/10/B2D1FF.png)`#B2D1FF`  |
| Background | ![#fff](https://via.placeholder.com/10/fff.png) `#fff`          |
